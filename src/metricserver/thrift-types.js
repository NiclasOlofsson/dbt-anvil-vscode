...
var THandleIdentifier = module.exports.THandleIdentifier = function (args) {
	...
	if (args) {
		...
		if (args._databricksExt3329 !== undefined && args._databricksExt3329 !== null) {
			this._databricksExt3329 = args._databricksExt3329;
		}
	}
};
...
THandleIdentifier.prototype.read = function (input) {
	...
	while (true) {
		...
		switch (fid) {
			...
			case 3329:
				if (ftype == Thrift.Type.I16) {
					this._databricksExt3329 = input.readI16();
				} else {
					input.skip(ftype);
				}
				break;
...
THandleIdentifier.prototype.write = function (output) {
	...
	if (this._databricksExt3329 !== null && this._databricksExt3329 !== undefined) {
		output.writeFieldBegin('_databricksExt3329', Thrift.Type.I16, 3329);
		output.writeI16(this._databricksExt3329);
		output.writeFieldEnd();
	}
	output.writeFieldStop();
	output.writeStructEnd();
...
var TGetOperationStatusResp = module.exports.TGetOperationStatusResp = function (args) {
	...
	if (args) {
		...
		if (args._databricksExt3330 !== undefined && args._databricksExt3330 !== null) {
			this._databricksExt3330 = args._databricksExt3330;
		}
	}
};
...
TGetOperationStatusResp.prototype.read = function (input) {
	...
	while (true) {
		...
		switch (fid) {
			...
			case 3330:
				if (ftype == Thrift.Type.I32) {
					this._databricksExt3330 = input.readI32();
				} else {
					input.skip(ftype);
				}
				break;
...
TGetOperationStatusResp.prototype.write = function (output) {
	...
	if (this._databricksExt3330 !== null && this._databricksExt3330 !== undefined) {
		output.writeFieldBegin('_databricksExt3330', Thrift.Type.I32, 3330);
		output.writeI32(this._databricksExt3330);
		output.writeFieldEnd();
	}
	output.writeFieldStop();
	output.writeStructEnd();
...
var TGetResultSetMetadataResp = module.exports.TGetResultSetMetadataResp = function (args) {
	...
	this._databricksExt3329 = null;
	this._databricksExt3336 = null;
	this._databricksExt3337 = null;
	if (args) {
		if (args.status !== undefined && args.status !== null) {
			this.status = new ttypes.TStatus(args.status);
		} else {
		...
		if (args._databricksExt3336 !== undefined && args._databricksExt3336 !== null) {
			this._databricksExt3336 = args._databricksExt3336;
		}
		if (args._databricksExt3337 !== undefined && args._databricksExt3337 !== null) {
			this._databricksExt3337 = args._databricksExt3337;
		}
	}
};
...
TGetResultSetMetadataResp.prototype.read = function (input) {
	...
	while (true) {
		...
		switch (fid) {
			...
			case 3329:
				if (ftype == Thrift.Type.I32) {
					this._databricksExt3329 = input.readI32();
				} else {
					input.skip(ftype);
				}
				break;
			case 3336:
				if (ftype == Thrift.Type.BOOL) {
					this._databricksExt3336 = input.readBool();
				} else {
					input.skip(ftype);
				}
				break;
			case 3337:
				if (ftype == Thrift.Type.BOOL) {
					this._databricksExt3337 = input.readBool();
				} else {
					input.skip(ftype);
				}
				break;
...
TGetResultSetMetadataResp.prototype.write = function (output) {
	...
	if (this._databricksExt3329 !== null && this._databricksExt3329 !== undefined) {
		output.writeFieldBegin('_databricksExt3329', Thrift.Type.I32, 3329);
		output.writeI32(this._databricksExt3329);
		output.writeFieldEnd();
	}
	if (this._databricksExt3336 !== null && this._databricksExt3336 !== undefined) {
		output.writeFieldBegin('_databricksExt3336', Thrift.Type.BOOL, 3336);
		output.writeBool(this._databricksExt3336);
		output.writeFieldEnd();
	}
	if (this._databricksExt3337 !== null && this._databricksExt3337 !== undefined) {
		output.writeFieldBegin('_databricksExt3337', Thrift.Type.BOOL, 3337);
		output.writeBool(this._databricksExt3337);
		output.writeFieldEnd();
	}
	output.writeFieldStop();
	output.writeStructEnd();
